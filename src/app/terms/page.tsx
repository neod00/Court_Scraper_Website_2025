...
export const metadata: Metadata = {
    title: '이용약관 | 대법원 회생·파산 자산매각 공고 자동조회 시스템',
    description: '대법원 회생·파산 자산매각 공고 자동조회 시스템의 이용약관입니다.',
};
            ...
            <div className="bg-white shadow rounded-lg p-6 space-y-8">
                ...
                <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        이 약관은 대법원 회생·파산 자산매각 공고 자동조회 시스템(이하 &quot;서비스&quot;)이 제공하는
                ...
                <section>
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-md">
                        <p className="text-yellow-800 leading-relaxed">
                            <strong>⚠️ 중요:</strong> 본 서비스에서 제공하는 정보는 참고용으로만 제공되며,
                ...
                <section>
                    <h2 className="text-xl font-semibold text-gray-800 mb-3">제5조 (서비스 이용)</h2>
                    <p className="text-gray-600 leading-relaxed">
                        본 서비스는 별도의 회원가입 없이 무료로 이용할 수 있습니다.
                        단, 서비스 운영을 위해 광고가 게재될 수 있습니다.
                    </p>
                </section>
