...
2. "full_report": 아래 구조를 **정확히** 따른 마크다운 리포트 (2500~4000자).
...
(부동산 공고의 전반적 특징을 2~3문장으로 서술한 뒤, 아래 항목별로 데이터를 정리)

- **📍 주요 지역**: (다수 매물이 등록된 지역/관할 법원)
- **🏢 매물 종류**: (아파트, 토지, 임야, 공장 등 확인된 지목/용도)
- **💰 가격대**: (최저매각가의 대략적 최저~최고 범위)
- **⚠️ 권리관계 특이사항**: (지분 매각, 유치권, 법정지상권 등 확인된 사항)

> 💬 **전문가 코멘트**: (부동산 데이터에서 입찰자가 유의할 실무적 포인트 1~2문장)

### 🚗 3. 차량/동산 매각 동향

(차량/동산 공고의 전반적 특징을 2~3문장으로 서술)

- **🚘 주요 차종**: (가장 많이 등장한 차종이나 구체적 모델명)
- **📅 연식 및 주행거리**: (대략적 연식 분포와 주행거리 범위)
- **💰 가격대**: (최저매각가 분포)
